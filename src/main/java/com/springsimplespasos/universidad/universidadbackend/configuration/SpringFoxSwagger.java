...
public class SpringFoxSwagger {
    ...
    private ApiInfo apiInfo(){
        return new ApiInfo(
                ...
                new Contact("Joan Fernando Ene", "https://github.com/FerJoanEne/spring-simples-pasos-project.git","fernandoene91@gmail.com"),
                "Licencia de API", "Licencia URL", Collections.emptyList()
        );
    }
}
